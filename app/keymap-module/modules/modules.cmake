...
if(cached_user_config_value STREQUAL ZMK_CONFIG)
  # The app build scripts did not set a default, The ZMK_CONFIG we are reading
  # is the cached value from the CLI
...
set(CACHED_ZMK_CONFIG
    ${ZMK_CONFIG}
    CACHE STRING "Selected user ZMK config")
...
foreach(root ${BOARD_ROOT})
  ...
  foreach(shields_refs ${shields_refs_list})
    ...
    file(
      GLOB shield_overlays
      RELATIVE ${shield_path}
      ${shield_path}/*.overlay
      )
...
# Given a shield like `kyria_rev2_left` we want to use `kyria_rev2` and `kyria`
# as candidate names for overlay/conf/keymap files.
if(DEFINED SHIELD)
  foreach(s ${SHIELD_AS_LIST})
